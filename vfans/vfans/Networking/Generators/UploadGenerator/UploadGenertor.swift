...
class UploadGenerator {
    ...
    //MARK:----------------------------- Public Methods -------------------------------
    func generateUploadWithServiceIdentifier(serviceId: String, requestParams: ParamData, methodName: String) -> NSURLRequest {
    ...
    static let sharedInstance = UploadGenerator()
}